...
parkinsons_model = pickle.load(
    open(
        "/Users/nizam/Documents/kuliah/semester 5/Datmin/models/parkinsons_model.sav",
        "rb",
    )
)
...
parkinsons_data = pd.read_csv(
    "/Users/nizam/Documents/kuliah/semester 5/Datmin/data/parkinsons.csv"
)
# Penjelasan Dataset
if selected == "Penjelasan Dataset":
    ...
    st.write(
        "7. MDVP:PPQ: Average absolute perturbation dalam siklus suara (yang berbeda dengan MDVP:RAP)."
    )
    st.write(
        "8. Jitter:DDP: Jitter dalam suara, yang merupakan perpanjangan dari MDVP:Jitter."
    )
    st.write(
        "9. MDVP:Shimmer: Shimmer adalah ukuran dari perubahan dalam amplitudo dalam suara."
    )
    st.write(
        "10. MDVP:Shimmer(dB): Shimmer dalam desibel (dB). Ini adalah ukuran perubahan amplitudo dalam dB."
    )
